...
| <a href="https://github.com/blueyaGIT/minishell"><img src="https://github.com/blueyaGIT/blueyaGIT/blob/master/42_badges/minishelln.png" width="50"></a>                                                 | Making of a custom shell with brackets for <br> priorities, ’, ", <, >, <<, >>, pipes, $, $?, a history, <br> echo, cd, pwd, export, unset, env, exit, <br> correct executable execution, and a bunch more.                                                                               | 🛠️ /100  | 🛠️ / 25  |
